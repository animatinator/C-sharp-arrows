...
\usepackage{listings}
\lstset{basicstyle=\ttfamily,breaklines=true,language={[Sharp]C}} %\scriptsize
...
%Set code size to small from here on so things fit in
\lstset{basicstyle=\ttfamily\scriptsize,breaklines=true,language={[Sharp]C}}

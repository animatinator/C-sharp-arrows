...
\begin{itemize}
	\item Basic operators -- how to create, combine and first/second arrows
	\item Other operators like And (mention it's parallel)
	\item Advanced operators
	\item Table illustrating mapping between C$\sharp$ operators and Haskell equivalents
\end{itemize}
...
Figures [blah] give a visual representation of some of the arrow operators, to make their effects more clear.
